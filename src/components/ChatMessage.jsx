...
const ChatMessage = (props) => {
  ...
  return (
    <div
      className="mb-4 px-3 overflow-y-scroll"
            ...
            return (
              <div key={message._id} ref={scrollRef}>
                ...
                >
                    ...
                    <div className="w-10 rounded-full">
                      {message.senderId ? (
                        ...
                        >
                          ...
                          <g mask="url(#:ra:)">
                            <rect width="36" height="36" fill="#cbdcdf"></rect>
                            <rect
                              x="0"
                              y="0"
                              width="36"
                        ...
                        >
                          ...
                          <g mask="url(#:r34:)">
                            <rect width="36" height="36" fill="#07abf5"></rect>
                            <rect
                              x="0"
                              y="0"
                              width="36"
                  ...
                  handleTimeDifference(message.createdAt) ? (
                    <div
                      className={`dropdown text-xs ${
                        message.senderId === userId
                          ? "dropdown-left"
                          : "dropdown-right"
                      }`}
                    >
                      ...
                      >
                        <li
                          onClick={() =>
                            handleSetUpdateMessage(message.message, message._id)
                          }
                        >
                          <a>edit</a>
                        </li>
