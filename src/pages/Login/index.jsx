...
const Login = () => {
  ...
  return (
    <section className="w-full py-9 h-full ">
      <div className="flex flex-row w-5/6 m-auto ">
        ...
        <div className="right-sec w-1/2">
          ...
          <p className="sub-heading text-gray-400 text-sm text-center block mb-7 font-medium color">
          ...
          <div className="form-sec ps-28 w-11/2 mb-10 ">
            <form onSubmit={handleSubmit}>
              ...
              <input
                ...
                onBlur={handleBlur}
                className={`block w-5/6 h-10 rounded-md ml-3 mt-2 mb-2 py-1 bg pl-4 pr-20 text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-200 placeholder:text-gray-400 sm:text-sm sm:leading-6 bg-gray-100 ${
              ...
              <input
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                className={`block w-5/6 h-10 rounded-md ml-3 mt-2 mb-2 bg py-1 pl-4 pr-20 text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-200 placeholder:text-gray-400 sm:text-sm sm:leading-6 bg-gray-100 ${
              ...
              <div>
                <label className=" text-gray-600 color">
                  <input
                    type="checkbox"
                    checked={isChecked}
